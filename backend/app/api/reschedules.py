...
async def reschedule_booking(
    ...
    target_court_id = payload.court_id or booking.court_id
    ...
    if Decimal(new_total) != Decimal(booking.total_amount):
        raise HTTPException(409, "The new slot has a different price. Price-adjusted rescheduling is not available yet.")
    ...
    try:
        ...
        db.add(Notification(
            ...
            body=f"Booking {booking.booking_code} has been moved to {payload.booking_date.isoformat()}.",
            payload={
